...
class Point:
    ...
    # Данный способ не подойдет, так как при добавлении новой системы координат придется нарушить 2 принцип SOLID
    ...
    # Добавляем класс внутрь класса Point, чтобы изнутри использовать определенный метод создания
    class Factory:
        @staticmethod
        def new_cartesian_point(x, y):
            return Point(x, y)
